...
//	private static final String FLIGHT_SERVICE_URL = "http://localhost:8081/flights/book/";
	private static final String HOTEL_SERVICE_URL = "http://hotel-service-kafka/hotels/";
	private static final String FLIGHT_SERVICE_URL = "http://flights-service/flights/book/";
	private BookingService bookingService;
	private RestClient restClient;
	@Autowired
	private KafkaHotelListener kafkaHotelListener;
	
	public void setKafkaHotelListener(KafkaHotelListener listener) {
		this.kafkaHotelListener = listener;
	}
